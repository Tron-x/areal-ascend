...
class MonarchVLLMEngine(InferenceEngine):
    ...
    def __init__(
        ...
        self._bg_thread = threading.Thread(
            target=self._bg_loop.run_forever, daemon=True, name="MonarchVLLMEngine_bg_loop"
        )
    ...
    def _wrap_with_agent_workflow(self, workflow):
        ...
        """
        from areal.monarch_plugin.agent_actor import MonarchAgentWorkflow
    ...
    def _inject_monarch_reward(self, workflow):
        ...
        """
        from areal.monarch_plugin.reward_actor import MonarchRewardWrapper
