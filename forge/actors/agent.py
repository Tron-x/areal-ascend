...
class AgentActor(ForgeActor):
    ...
    # ------------------------------------------------------------------
    # CLI-Native Mode -- delegated to forge.service.cli_native
    # ------------------------------------------------------------------
    # See forge.service.model_proxy_server + forge.agents.external
    # for the HTTP-based external agent integration.
